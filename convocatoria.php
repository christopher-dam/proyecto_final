...
<body>
  ...
  <div class="container">
    <div style="justify-content: center; align-items:center; min-height:100vh; display:flex;">
      <form method="post" action="ajaxmensaje.php" enctype="multipart/form-data" style="padding:10px 20px; width:50%; background-color: rgb(0,0,0,0.5) !important; border-radius: 25px;">

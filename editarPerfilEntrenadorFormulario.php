...
<body>
  ...
  <div class="container">
    <div style="justify-content: center; align-items:center; min-height:100vh; display:flex;">
      <form  style="padding:10px 20px; background-color: rgb(0,0,0,0.5) !important; border-radius: 25px;" id="formEditar" name="formEditar" method="post" action="editarPerfilJugador.php" onsubmit="return validarperfil()" enctype="multipart/form-data">

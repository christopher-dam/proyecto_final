 ...
 */
 ...
 (function($) {
     ...
     var strings = {
         ...
         no_events_in_day: 'Sin eventos en este día.',
 
         tipo_year: '{0}',
         tipo_month: '{0} {1}',
         tipo_week: 'week {0} of {1}',
         tipo_day: '{0} {1} {2}, {3}',
     ...
     Calendar.prototype.getTitle = function() {
         ...
         switch(this.options.view) {
             case 'year':
                 return this.locale.tipo_year.format(p.getFullYear());
                 break;
             case 'month':
                 return this.locale.tipo_month.format(this.locale['m' + p.getMonth()], p.getFullYear());
                 break;
             case 'week':
                 return this.locale.tipo_week.format(p.getWeek(getExtentedOption(this, 'week_numbers_iso_8601')), p.getFullYear());
                 break;
             case 'day':
                 return this.locale.tipo_day.format(this.locale['d' + p.getDay()], p.getDate(), this.locale['m' + p.getMonth()], p.getFullYear());
                 break;
         }
         return;
     };
             ...
             if(!modal.data('handled.bootstrap-calendar') || (modal.data('handled.bootstrap-calendar') && modal.data('handled.event-id') != event.id)) {
                 modal.off('show.bs.modal')
                     ...
                     .on('show.bs.modal', function() {
                         ...
                         if(_.isFunction(self.options.modal_tipo)) {
                             modal.find(".modal-tipo").html(self.options.modal_tipo(event));
                         }
                     })
